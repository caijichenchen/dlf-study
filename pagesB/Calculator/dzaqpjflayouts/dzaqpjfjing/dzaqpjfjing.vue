<template>
	...
	<base-layout>
		<template v-slot:jsq>
			<!-- 设计费计算选项 -->
			<dzaqpjf-counter-jing></dzaqpjf-counter-jing>
			<!-- 设计费计算按钮 -->
...
<script>
	...
	import dzaqpjfCounterJing from "@/Calculator/dzaqpjf/dzaqpjf-counter_jing.vue"
	...
	export default {
		data() {
			return {
				countData:{
					url: this.$serverUrl+'/api/dzaqpjfJing',  //api请求
					count:2  //积分消耗
				},
				title:'北京'
			}
