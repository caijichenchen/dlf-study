<template>
	...
	<base-layout>
		<template v-slot:jsq>
			<!-- 设计费计算选项 -->
			<fkdxyjjsf-counter-zhe></fkdxyjjsf-counter-zhe>
			<!-- 设计费计算按钮 -->
...
<script>
	...
	import fkdxyjjsfCounterZhe from "@/Calculator/fkdxyjjsf/fkdxyjjsf_counter_zhe.vue"
	...
	export default {
		data() {
			return {
				countData:{
					url: this.$serverUrl + '/api/fkdxyjjsfZhe',  //api请求
					count:2  //积分消耗
				},
				title:'浙江'
			}
