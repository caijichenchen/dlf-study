<template>
	...
	<base-layout>
		<template v-slot:jsq>
			<!-- 设计费计算选项 -->
			<fkdxyjjsf-counter-meng></fkdxyjjsf-counter-meng>
			<!-- 设计费计算按钮 -->
...
<script>
	...
	import fkdxyjjsfCounterMeng from "@/Calculator/fkdxyjjsf/fkdxyjjsf_counter_meng.vue"
	...
	export default {
		data() {
			return {
				countData:{
					url: this.$serverUrl + '/api/fkdxyjjsfMeng',  //api请求
					count:2  //积分消耗
				},
				title:'内蒙古'
			}
