<template>
	...
	<base-layout>
		<template v-slot:jsq>
			<!-- 设计费计算选项 -->
			<fkdxyjjsf-counter-xiang></fkdxyjjsf-counter-xiang>
			<!-- 设计费计算按钮 -->
...
<script>
	...
	import fkdxyjjsfCounterXiang from "@/Calculator/fkdxyjjsf/fkdxyjjsf_counter_xiang.vue"
	...
	export default {
		data() {
			return {
				countData:{
					url: this.$serverUrl + '/api/fkdxyjjsfXiang',  //api请求
					count:2  //积分消耗
				},
				title:'湖南'
			}
