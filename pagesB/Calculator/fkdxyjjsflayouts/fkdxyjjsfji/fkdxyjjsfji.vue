<template>
	...
	<base-layout>
		<template v-slot:jsq>
			<!-- 设计费计算选项 -->
			<fkdxyjjsf-counter-ji></fkdxyjjsf-counter-ji>
			<!-- 设计费计算按钮 -->
...
<script>
	...
	import fkdxyjjsfCounterJi from "@/Calculator/fkdxyjjsf/fkdxyjjsf_counter_ji.vue"
	...
	export default {
		data() {
			return {
				countData:{
					url: this.$serverUrl + '/api/fkdxyjjsfJi',  //api请求
					count:2  //积分消耗
				},
				title:'河北省'
			}
