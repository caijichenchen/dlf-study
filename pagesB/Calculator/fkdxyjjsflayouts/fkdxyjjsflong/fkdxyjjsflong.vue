<template>
	...
	<base-layout>
		<template v-slot:jsq>
			<!-- 设计费计算选项 -->
			<fkdxyjjsf-counter-long></fkdxyjjsf-counter-long>
			<!-- 设计费计算按钮 -->
...
<script>
	...
	import fkdxyjjsfCounterLong from "@/Calculator/fkdxyjjsf/fkdxyjjsf_counter_long.vue"
	...
	export default {
		data() {
			return {
				countData:{
					url: this.$serverUrl + '/api/fkdxyjjsfLong',  //api请求
					count:2  //积分消耗
				},
				title:'甘肃'
			}
