<template>
	...
	<base-layout>
		<template v-slot:jsq>
			<!-- 设计费计算选项 -->
			<hjyxpjf-counter-meng></hjyxpjf-counter-meng>
			<!-- 设计费计算按钮 -->
...
<script>
	...
	import hjyxpjfCounterMeng from "@/Calculator/hjyxpjf/hjyxpj_counter_meng.vue"
	...
	export default {
		data() {
			return {
				countData:{
					url:this.$serverUrl + '/api/hjyxpjMeng',  //api请求
					count:2  //积分消耗
				},
				title:'内蒙古'
			}
