	...
	<view class="cu-modal" :class="showModalName== modalName ?'show':''">
		<view class="cu-dialog">
			<view class="cu-bar bg-white justify-end">
				<view class="content">工程其他测量附加调整系数</view>
...
<script>
	...
	export default {
		...
		data() {
			return {
				modalName:'gcqtclsfGuo_fjtz',
				tzxsList:[
					{content:"1.默认为1",val:"1.0"},
					{content:"2.地形图数字化-建筑群区：附加调整系数为2.0",val:"2.0"},
					{content:"3.地形图缩放-建筑群区：附加调整系数为1.5",val:"1.5"}
				]
			}
		},
		components: {
