<template>
	...
	<base-layout>
		<template v-slot:jsq>
			<!-- 设计费计算选项 -->
			<csjcsspt-counter-hei></csjcsspt-counter-hei>
			<!-- 设计费计算按钮 -->
...
<script>
	...
	import csjcssptCounterHei from "@/Calculator/csjcsspt/csjcsspt_counter_hei.vue"
	...
	export default {
		data() {
			return {
				countData:{
					url: this.$serverUrl + '/api/csjcssptHei',  //api请求
					count:2  //积分消耗
				},
				title:'黑龙江'
			}
