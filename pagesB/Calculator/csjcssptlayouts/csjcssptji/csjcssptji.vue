<template>
	...
	<base-layout>
		<template v-slot:jsq>
			<!-- 设计费计算选项 -->
			<csjcsspt-counter-ji></csjcsspt-counter-ji>
			<!-- 设计费计算按钮 -->
...
<script>
	...
	import csjcssptCounterJi from "@/Calculator/csjcsspt/csjcsspt_counter_ji.vue"
	...
	export default {
		data() {
			return {
				countData:{
					url: this.$serverUrl + '/api/csjcssptJi',  //api请求
					count:2  //积分消耗
				},
				title:'河北'
			}
