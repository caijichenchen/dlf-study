<template>
	...
	<base-layout>
		<template v-slot:jsq>
			<!-- 设计费计算选项 -->
			<jsxmqqgzzxf-counter-jin></jsxmqqgzzxf-counter-jin>
			<!-- 设计费计算按钮 -->
...
<script>
	...
	import jsxmqqgzzxfCounterJin from "@/Calculator/jsxmqqgzzxf/jsxmqqgzzxf_counter_tianjin.vue"
	import jsxmqqgzzxfResult from "../jsxmqqgzzxf_result.vue"
	export default {
		data() {
			return {
				countData:{
					url:this.$serverUrl + '/api/jsxmqqgzzxfTianjin',  //api请求
					count:2  //积分消耗
				},
				title:'天津'
			}
