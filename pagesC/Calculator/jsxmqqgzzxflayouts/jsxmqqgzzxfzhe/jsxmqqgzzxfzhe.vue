<template>
	...
	<base-layout>
		<template v-slot:jsq>
			<!-- 设计费计算选项 -->
			<jsxmqqgzzxf-counter-zhe></jsxmqqgzzxf-counter-zhe>
			<!-- 设计费计算按钮 -->
...
<script>
	...
	import jsxmqqgzzxfCounterZhe from "@/Calculator/jsxmqqgzzxf/jsxmqqgzzxf_counter_zhe.vue"
	import jsxmqqgzzxfResult from "../jsxmqqgzzxf_result.vue"
	export default {
		data() {
			return {
				countData:{
					url:this.$serverUrl + '/api/jsxmqqgzzxfZhe',  //api请求
					count:2  //积分消耗
				},
				title:'浙江省'
			}
