<template>
	...
	<base-layout>
		<template v-slot:jsq>
			<!-- 设计费计算选项 -->
			<jsxmqqgzzxf-counter-xiang></jsxmqqgzzxf-counter-xiang>
			<!-- 设计费计算按钮 -->
...
<script>
	...
	import jsxmqqgzzxfCounterXiang from "@/Calculator/jsxmqqgzzxf/jsxmqqgzzxf_counter_xiang.vue"
	import jsxmqqgzzxfResult from "../jsxmqqgzzxf_result.vue"
	export default {
		data() {
			return {
				countData:{
					url:this.$serverUrl + '/api/jsxmqqgzzxfXiang',  //api请求
					count:2  //积分消耗
				},
				title:'湖南省'
			}
