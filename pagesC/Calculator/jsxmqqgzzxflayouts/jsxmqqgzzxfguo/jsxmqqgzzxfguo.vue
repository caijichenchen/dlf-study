<template>
	...
	<base-layout>
		<template v-slot:jsq>
			<!-- 设计费计算选项 -->
			<jsxmqqgzzxf-counter-guo></jsxmqqgzzxf-counter-guo>
			<!-- 设计费计算按钮 -->
...
<script>
	...
	import jsxmqqgzzxfCounterGuo from "@/Calculator/jsxmqqgzzxf/jsxmqqgzzxf_counter_guo.vue"
	import jsxmqqgzzxfResult from "../jsxmqqgzzxf_result.vue"
	export default {
		data() {
			return {
				countData:{
					url:this.$serverUrl + '/api/jsxmqqgzzxfGuo',  //api请求
					count:2  //积分消耗
				},
				title:'全国'
			}
