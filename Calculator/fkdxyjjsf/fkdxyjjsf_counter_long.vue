	...
	<view>
		...
		<form>
			<view class="cu-form-group" v-show="showSelector.fkdxyjjsfLong_province">
				...
				<picker class="select" @change="PickerChange" data-index='index0' data-name="fkdxyjjsfLong_province" :value="pickerIndex.index0"
				 :range="multiSelector.fkdxyjjsfLong_province">
					<view class="picker">
						{{pickerIndex.index0 >-1?multiSelector.fkdxyjjsfLong_province[pickerIndex.index0]:'甘肃'}}
					</view>
				</picker>
			</view>
			<view class="cu-form-group" v-show="showSelector.fkdxyjjsfLong_standard">
				<view class="title">计算依据</view>
				<picker class="select" @change="PickerChange" data-index='index1' data-name="fkdxyjjsfLong_standard" :value="pickerIndex.index1"
				 :range="multiSelector.fkdxyjjsfLong_standard">
					<view class="picker">
						{{pickerIndex.index1>-1?multiSelector.fkdxyjjsfLong_standard[pickerIndex.index1]:'甘价服务〔2004〕第181号'}}
					</view>
				</picker>
			</view>
			<view class="cu-form-group" style="border-top: 1upx solid #eee;">
				<view class="title">建设面积</view>
				<input type="text" id="sjf" v-model="needVal.fkdxyjjsfLong_jsmj"></input>
			...
			<view class="cu-form-group" v-show="showSelector.fkdxyjjsfLong_category">
				<!-- <input type="hidden" v-show='false' v-model="needVal.fkdxyjjsfLong_graded"> -->
				<view class="title">计算区域</view>
				<picker class="select" @change="PickerChange" data-index='index2' data-name="fkdxyjjsfLong_category" :value="pickerIndex.index2"
				 :range="multiSelector.fkdxyjjsfLong_category">
					<view class="picker">
						{{multiSelector.fkdxyjjsfLong_category[pickerIndex.index2]}}
					</view>
				</picker>
			...
			<view class="cu-form-group">
				...
				<input v-model="needVal.fkdxyjjsfLong_discount" /></input>
				<uni-tag text="%" type="defult"></uni-tag>
...
<script>
	...
	import datajson from '@/common/json/fkydjsfs/fkydjsfs-long.json'
