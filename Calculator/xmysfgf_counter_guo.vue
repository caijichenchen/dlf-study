	...
	<view>
		...
		<form>
			<view class="cu-form-group">
				...
				<picker class="select" @change="PickerChange" v-model="needVal.xmysfgf_jsyj" :range="picker1">
					<view class="picker" >
						NB/T 32027--2016
					</view>
				</picker>
			...
			<view class="cu-form-group" style="border-top: 1upx solid #eee;">
				...
				<input type="text" id="sjf" v-model="needVal.xmysfgfGuo_gczj"></input>
				<uni-tag  text="万元" type="defult">万元</uni-tag>
			</view>
			<view class="cu-form-group">
				<view class="title">打折折扣</view>
				<input name="sjfGuo_discount" v-model="needVal.xmysfgfGuo_dzzk" /></input>
				<uni-tag text="%" type="defult"></uni-tag>
				<button type="primary" size="mini" @tap="showdzzk" :data-target="JSON.stringify(explain[0])">查看说明</button>
			</view>
			
			<!-- <xmysfgf-guo-jsyj v-bind:showModalName="showModalName" v-on:hideModal='hideModal'></xmysfgf-guo-jsyj> -->
		</form>
		<explain></explain>
	</view>
</template>
...
<script>
	...
	// import xmysfgfGuoJsyj from "./xmysfgfGuo_jsyj.vue"
	export default {
		mixins: [counterMixin],
		data() {
			return {
