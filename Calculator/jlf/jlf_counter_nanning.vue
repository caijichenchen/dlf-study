	...
	<view>
		...
		<form>
			<view class="cu-form-group">
				...
				<view class="title">南监协知[2016]033号</view>
			</view>
			<view class="cu-form-group">
...
<script>
	...
	import jlfqianFjtz from "@/pagesC/Calculator/jlflayouts/jlfnanning/jlfBa_fjtz.vue"
	import jlfqianFztz from "@/pagesC/Calculator/jlflayouts/jlfnanning/jlfBa_fztz.vue"
	export default {
		mixins: [counterMixin],
		data() {
			return {
