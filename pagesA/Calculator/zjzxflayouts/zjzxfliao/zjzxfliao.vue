<template>
	...
	<base-layout>
		<template v-slot:jsq>
			<!-- 设计费计算选项 -->
			<zjzxf-counter-liao :title="title"></zjzxf-counter-liao>
			<!-- 设计费计算按钮 -->
...
<script>
	...
	import zjzxfCounterLiao from "@/Calculator/zjzxf/zjzxf-counter_liao.vue"
	...
	export default {
		data() {
			return {
				countData:{
					url: this.$serverUrl+'/api/zjzxfLiao',  //api请求
					count:2  //积分消耗
				},
				title: "辽宁省造价咨询费"
			}
