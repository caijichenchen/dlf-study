<template>
	...
	<base-layout>
		<template v-slot:jsq>
			<!-- 设计费计算选项 -->
			<zjzxf-counter-qing :title="title"></zjzxf-counter-qing>
			<!-- 设计费计算按钮 -->
...
<script>
	...
	import zjzxfCounterQing from "@/Calculator/zjzxf/zjzxf-counter_qing.vue"
	...
	export default {
		data() {
			return {
				countData:{
					url: this.$serverUrl+'/api/zjzxfQing',  //api请求
					count:2  //积分消耗
				},
				title: "青海造价咨询费"
			}
