<template>
	...
	<base-layout>
		<template v-slot:jsq>
			<!-- 设计费计算选项 -->
			<zjzxf-counter-qiong :title="title"></zjzxf-counter-qiong>
			<!-- 设计费计算按钮 -->
...
<script>
	...
	import zjzxfCounterQiong from "@/Calculator/zjzxf/zjzxf-counter_qiong.vue"
	...
	export default {
		data() {
			return {
				countData:{
					url: this.$serverUrl+'/api/zjzxfQiong',  //api请求
					count:2  //积分消耗
				},
				title: "海南省造价咨询费"
			}
