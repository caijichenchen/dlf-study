<template>
	...
	<base-layout>
		<template v-slot:jsq>
			<!-- 设计费计算选项 -->
			<zjzxf-counter-xin :title="title"></zjzxf-counter-xin>
			<!-- 设计费计算按钮 -->
...
<script>
	...
	import zjzxfCounterXin from "@/Calculator/zjzxf/zjzxf-counter_xin.vue"
	...
	export default {
		data() {
			return {
				countData:{
					url: this.$serverUrl+'/api/zjzxfXin',  //api请求
					count:2  //积分消耗
				},
				title: "新疆造价咨询费"
			}
