<template>
	...
	<base-layout>
		<template v-slot:jsq>
			<!-- 设计费计算选项 -->
			<zjzxf-counter-shan :title="title"></zjzxf-counter-shan>
			<!-- 设计费计算按钮 -->
...
<script>
	...
	import zjzxfCounterShan from "@/Calculator/zjzxf/zjzxf-counter_shan.vue"
	...
	export default {
		data() {
			return {
				countData:{
					url: this.$serverUrl+'/api/zjzxfShan',  //api请求
					count:2  //积分消耗
				},
				title: "陕西省造价咨询费"
			}
