<template>
	...
	<base-layout>
		<template v-slot:jsq>
			<!-- 设计费计算选项 -->
			<zjzxf-counter-changge :title="title"></zjzxf-counter-changge>
			<!-- 设计费计算按钮 -->
...
<script>
	...
	import zjzxfCounterChangge from "@/Calculator/zjzxf/zjzxf-counter_changge.vue"
	...
	export default {
		data() {
			return {
				countData:{
					url: this.$serverUrl+'/api/zjzxfChangge',  //api请求
					count:2  //积分消耗
				},
				title: "长葛造价咨询费"
			}
