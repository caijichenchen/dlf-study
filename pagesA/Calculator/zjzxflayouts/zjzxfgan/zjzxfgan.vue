<template>
	...
	<base-layout>
		<template v-slot:jsq>
			<!-- 设计费计算选项 -->
			<zjzxf-counter-gan :title="title"></zjzxf-counter-gan>
			<!-- 设计费计算按钮 -->
...
<script>
	...
	import zjzxfCounterGan from "@/Calculator/zjzxf/zjzxf-counter_gan.vue"
	...
	export default {
		data() {
			return {
				countData:{
					url: this.$serverUrl+'/api/zjzxfGan',  //api请求
					count:2  //积分消耗
				},
				title: "江西省造价咨询费"
			}
