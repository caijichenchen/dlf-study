<template>
	...
	<base-layout>
		<template v-slot:jsq>
			<!-- 设计费计算选项 -->
			<zjzxf-counter-min :title="title"></zjzxf-counter-min>
			<!-- 设计费计算按钮 -->
...
<script>
	...
	import zjzxfCounterMin from "@/Calculator/zjzxf/zjzxf-counter_min.vue"
	...
	export default {
		data() {
			return {
				countData:{
					url: this.$serverUrl+'/api/zjzxfMin',  //api请求
					count:2  //积分消耗
				},
				title: "福建省造价咨询费"
			}
