<template>
	...
	<base-layout>
		<template v-slot:jsq>
			<!-- 设计费计算选项 -->
			<zjzxf-counter-chuan :title="title"></zjzxf-counter-chuan>
			<!-- 设计费计算按钮 -->
...
<script>
	...
	import zjzxfCounterChuan from "@/Calculator/zjzxf/zjzxf-counter_chuan.vue"
	...
	export default {
		data() {
			return {
				countData:{
					url: this.$serverUrl+'/api/zjzxfChuan',  //api请求
					count:2  //积分消耗
				},
				title: "四川省造价咨询费"
			}
