<template>
	...
	<base-layout>
		<template v-slot:jsq>
			<!-- 设计费计算选项 -->
			<zjzxf-counter-xiang :title="title"></zjzxf-counter-xiang>
			<!-- 设计费计算按钮 -->
...
<script>
	...
	import zjzxfCounterXiang from "@/Calculator/zjzxf/zjzxf-counter_xiang.vue"
	...
	export default {
		data() {
			return {
				countData:{
					url: this.$serverUrl+'/api/zjzxfXiang',  //api请求
					count:2  //积分消耗
				},
				title: "湖南省造价咨询费"
			}
