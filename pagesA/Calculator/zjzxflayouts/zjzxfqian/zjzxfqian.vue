<template>
	...
	<base-layout>
		<template v-slot:jsq>
			<!-- 设计费计算选项 -->
			<zjzxf-counter-qian :title="title"></zjzxf-counter-qian>
			<!-- 设计费计算按钮 -->
...
<script>
	...
	import zjzxfCounterQian from "@/Calculator/zjzxf/zjzxf-counter_qian.vue"
	...
	export default {
		data() {
			return {
				countData:{
					url: this.$serverUrl+'/api/zjzxfQian',  //api请求
					count:2  //积分消耗
				},
				title: "贵州省造价咨询费"
			}
