<template>
	...
	<base-layout>
		<template v-slot:jsq>
			<!-- 设计费计算选项 -->
			<zcpgsf-counter-xiang></zcpgsf-counter-xiang>
			<!-- 设计费计算按钮 -->
...
<script>
	...
	import zcpgsfCounterXiang from "@/Calculator/zcpgsf/zcpgsf_counter_xiang.vue"
	...
	export default {
		data() {
			return {
				countData:{
					url: this.$serverUrl + '/api/zcpgsfXiang',  //api请求
					count:2  //积分消耗
				},
				title: '湖南'
			}
