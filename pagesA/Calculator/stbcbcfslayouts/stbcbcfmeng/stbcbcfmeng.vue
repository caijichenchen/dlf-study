<template>
	...
	<base-layout>
		<template v-slot:jsq>
			<!-- 设计费计算选项 -->
			<stbcbcf-counter-meng></stbcbcf-counter-meng>
			<!-- 设计费计算按钮 -->
...
<script>
	...
	import stbcbcfCounterMeng from "@/Calculator/stbcbcf/stbcbcf_counter_meng.vue"
	...
	export default {
		data() {
			return {
				countData:{
					url: this.$serverUrl + '/api/stbcbcfMeng',  //api请求
					count:2  //积分消耗
				},
				title:'内蒙古'
			}
