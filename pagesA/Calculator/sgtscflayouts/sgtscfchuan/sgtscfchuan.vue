<template>
	...
	<base-layout>
		<template v-slot:jsq>
			<!-- 设计费计算选项 -->
			<sgtscf-counter-chuan></sgtscf-counter-chuan>
			<!-- 设计费计算按钮 -->
...
<script>
	...
	import sgtscfCounterChuan from "@/Calculator/sgtscf/sgtscf_counter_chuan.vue"
	...
	export default {
		data() {
			return {
				countData:{
					url: this.$serverUrl + '/api/sgtscfChuan',  //api请求
					count:2  //积分消耗
				}
			}
		},
