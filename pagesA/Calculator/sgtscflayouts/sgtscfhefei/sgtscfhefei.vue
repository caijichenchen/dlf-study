<template>
	...
	<base-layout>
		<template v-slot:jsq>
			<!-- 设计费计算选项 -->
			<sgtscf-counter-hefei></sgtscf-counter-hefei>
			<!-- 设计费计算按钮 -->
...
<script>
	...
	import sgtscfCounterHefei from "@/Calculator/sgtscf/sgtscf_counter_hefei.vue"
	...
	export default {
		data() {
			return {
				countData:{
					url: this.$serverUrl + '/api/sgtscfHefei',  //api请求
					count:2  //积分消耗
				}
			}
		},
