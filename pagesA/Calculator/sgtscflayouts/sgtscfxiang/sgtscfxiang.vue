<template>
	...
	<base-layout>
		<template v-slot:jsq>
			<!-- 设计费计算选项 -->
			<sgtscf-counter-xiang></sgtscf-counter-xiang>
			<!-- 设计费计算按钮 -->
...
<script>
	...
	import sgtscfCounterXiang from "@/Calculator/sgtscf/sgtscf_counter_xiang.vue"
	...
	export default {
		data() {
			return {
				countData:{
					url: this.$serverUrl + '/api/sgtscfXiang',  //api请求
					count:2  //积分消耗
				}
			}
		},
