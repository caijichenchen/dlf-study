<template>
	...
	<base-layout>
		<template v-slot:jsq>
			<!-- 设计费计算选项 -->
			<sgtscf-counter-qiong></sgtscf-counter-qiong>
			<!-- 设计费计算按钮 -->
...
<script>
	...
	import sgtscfCounterQiong from "@/Calculator/sgtscf/sgtscf_counter_qiong.vue"
	...
	export default {
		data() {
			return {
				countData:{
					url: this.$serverUrl + '/api/sgtscfQiong',  //api请求
					count:2  //积分消耗
				}
			}
		},
